...
function heatMapMatrix = generate_cell_intensity_filepath_with_config_elham(CombinedFlag,panoFilePath,cellTypeFilePath,allRegIndsPath,IndicatorsList,TypeList,JMF_folderpath,input_pano_folder,allCellTypes)
