...
clc;
addpath(genpath('Lib'))
config_file_path = 'config_Brain_DS1.csv';
...
for indexGroup = 1 : nOfGroups
    ...
    for indexFile = 1  : nOfFiles
        ...
        if csvFilePathSourceFound==0        
            heatMapMatrix = generate_heatmap_per_scan_filepath_with_config_modify(CombinedFlag,panoFilePath,cellTypeFilePath,allRegIndsPath,IndicatorsList,allLabels,2);
